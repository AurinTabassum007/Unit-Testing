...
{      
    ...
    {
        SqlConnection conn = new SqlConnection(@"Data Source=DELL\SQLEXPRESS;Initial Catalog=busdb;Integrated Security= true;");
        int bus_id1;
        string bus_name;
        string from_where;
        string to_where;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "" && textBox2.Text != "" && textBox3.Text != "")
            {
                ...
                {
                    MessageBox.Show("There is no such schedule");
                    conn.Close();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            if (textBox6.Text != "" && textBox5.Text != "" && textBox7.Text != "" && bus_id1 > 0 && bus_name != "" && from_where != "" && to_where != "" && dep_time != "" && arr_time != "" && date_of_journey != "")
            {
                ...
                PdfWriter.GetInstance(document, new FileStream("Desktop" + textBox6.Text + ".pdf", FileMode.Create));
                document.Open();
                ...
                MessageBox.Show("Successfully booked and ticket is generated.");
